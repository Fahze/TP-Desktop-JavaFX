...
import static com.fahze.demojavafx.ExpenseDAO.fetchAllDb;
...
public class ExpenseController {
    ...
    protected static ObservableList<Line> data = FXCollections.observableArrayList();
    ...
    public void openAddLineDialog() {
        try {
            ...
            result.ifPresent(ExpenseDAO::insertLine);
            fetchAllDb();
